...
import com.anu.bank.model.BankAccount;
...
public class CustomerDaoImpl implements CustomerDao {
	...
	public boolean updatePassword(Customer customer, String oldPassword, String newPassword)throws DataAccessException{
		// TODO Auto-generated method stub
		try {
			return (jdbcTemplate.update("update customerdata set password = ? where customerid=? and password=?",new Object[] {newPassword,customer.getCustomerId(),oldPassword})!=0);
